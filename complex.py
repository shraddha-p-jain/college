...
class Complex():
    ...
    def arg(self):
        ...
        def __mul__(self, other):
            return Complext(self.re*other.re-self.im*other.im, self.re*other.re+self.im*other.re)
        ...
        def __eq__(self,other):
            ...
            if isinstance(other,float) or isinstance(other,imt):
                return self.re==other and self.im==0
            return NotImplemented
        def __ne__(self,other):
            if isinctance(other,Complex):
